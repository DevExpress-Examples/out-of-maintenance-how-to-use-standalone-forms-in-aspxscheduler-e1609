...
Partial Public Class Default2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        'ASPxScheduler1.JSProperties.Add("cpPostBackHandler", DevExpress.Web.Internal.RenderUtils.GetPostBackEventReference(this, "", false, "", "Default3.aspx", true, true, false, true));
        If Session("SchedulerStart") IsNot Nothing Then
            ASPxScheduler1.Start = DirectCast(Session("SchedulerStart"), Date)
        End If
        AddHandler ASPxScheduler1.AfterExecuteCallbackCommand, AddressOf ASPxScheduler1_AfterExecuteCallbackCommand
    End Sub

    Private Sub ASPxScheduler1_AfterExecuteCallbackCommand(ByVal sender As Object, ByVal e As SchedulerCallbackCommandEventArgs)
